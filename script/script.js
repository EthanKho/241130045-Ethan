...
//Perilaku untuk kotak input kode promo
...
//Reset & Apply Form, memunculkan ataupun menghapus output
...
orderForm.addEventListener('submit', (e) => {
    ...
    //Menghitung total awal dan total akhir setelah diskon
...
$('#reset').click(() => {
    ...
    $('card-produk input').each((quantity) => {
        $(quantity).val(1);
    });
});